Storehouse.data = {
  ...
  user: {
    ...
    avatar_image: {
      representations: {
        "120": { url: "media/73b9c952-f6b9-47b4-becd-116d6c886d71.jpeg", size: { width: 120, height: 120 }},
        "320": { url: "media/33a38ca4-0969-405a-9db6-cf21115eee0f.jpeg", size: { width: 200, height: 200 }}
      },
    ...
    stories: [
      ...
      },
      {
        ...
        cover_media: {
          image: {
            representations: {
              "512": { url: "media/1a2dc51b-d05e-489d-a0a6-c149a42dd622.jpg", size: { width: 512, height: 277 } }
            },
            focalpoint: { x: 0.5, y: 0.5 },
            size: { width: 1024, height: 553 }
          }
        }
      },
      {
      ...
      },
      {
        ...
        cover_media: {
          image: {
            representations: {
              "512": { url: "media/ee3c4d7e-902d-4406-a326-9a37ddd840e0.jpg", size: { width: 512, height: 341 } }
            },
            focalpoint: { x: 0.5, y: 0.5 },
            size: { width: 1024, height: 682 }
          }
      ...
      },
      {
        ...
        cover_media: {
          image: {
            representations: {
              "512": { url: "media/28c76f47-0fed-4ca4-a9db-023a03b4c1e9.jpg", size: { width: 384, height: 512 } }
            },
            focalpoint: { x: 0.5, y: 0.5 },
      ...
      },
      {
        ...
        cover_media: {
          image: {
            representations: {
              "512": { url: "media/9c5db79c-4171-4700-b4cd-78a7e30242cc.jpg", size: { width: 512, height: 341 } }
            },
            focalpoint: { x: 0.5, y: 0.5 },
            size: { width: 1024, height: 682 }
          }
      ...
      },
      {
        ...
        cover_media: {
          image: {
            representations: {
              "512": { url: "media/7e9b7d80-4a8f-4b2e-a031-ca0d45b1f2f7.jpg", size: { width: 512, height: 341 } }
            },
            focalpoint: { x: 0.5, y: 0.5 },
